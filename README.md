...
_An AI-powered web app that adapts to your mental state — built for users with ADHD, autism, anxiety, and sensory sensitivities._
...
| **Security**       | bcrypt, express-rate-limit, express-validator, helmet         |
...
_Soft lavender theme for relaxed, focused work_

### ⚡ Focused Mode

_Dark theme for deep work sessions_

### ✨ Playful Mode

_Vibrant theme for creative exploration_

### 🎨 AI Image Generation

_Create art from text descriptions_

### 🎤 Voice-to-Text

_Real-time transcription with language support_

### 🎮 Interactive Games

_Four AI-powered games for cognitive engagement_
...
<details> <summary><strong>🔵 Google OAuth 2.0 Setup</strong></summary>
Go to Google Cloud Console → Credentials
Create new project → OAuth 2.0 Client ID
...
</details><details> <summary><strong>⚫ GitHub OAuth Setup</strong></summary>
...
Create new Web Service → Connect your fork
Configure:
...
Update OAuth callbacks with your production URL
Deploy!
[!IMPORTANT]
...
GitHub: @JohanDanielM
Project Link: https://github.com/JohanDanielM/amora-ai
Live Demo: https://amora-ai.onrender.com
